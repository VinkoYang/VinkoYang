---
layout: post
title: "Graduate Research Presentation Expectations"
date: 2026-08-14
...
If you want the other half of this — what a talk that meets these standards actually looks like, slide by slide — that is [the companion post](/blogs/how-to-build-a-good-research-presentation/). And once you have the craft, there is still the question of the room you are standing in: a lab seminar, a full-paper session, and a presentation-only slot are not the same talk, and [the third post in this series](/blogs/presentation-strategy-by-venue/) works through what each one has earned and what you should hold back.
